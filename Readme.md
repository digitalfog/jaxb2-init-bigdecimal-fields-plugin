...
[ ![Build Status](https://travis-ci.org/digitalfog/jaxb2-init-bigdecimal-fields-plugin.png?branch=master)](https://travis-ci.org/digitalfog/jaxb2-init-bigdecimal-fields-plugin)
